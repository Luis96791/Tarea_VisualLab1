...
init -1 python hide:
    ...
    ## Sonidos utilizados cuando se hace clic en un botón o "imagemap".
     ...
     # style.button.activate_sound = "button-3.wav"
     # style.imagemap.activate_sound = "button-3.wav"

    ## Sonidos utilizados cuando se entra o sale del menú del juego.

     # config.enter_sound = "button-3.wav"
     # config.exit_sound = "button-3.wav"

    ## Sonido de ejemplo utilizado para comprobar el volumen.

    # config.sample_sound = "button-3.wav"
...
python early:
    config.save_directory = "Conciencia_Ecologica-1422310445"
...
image main_menu:
    contains:
        ## Color de fondo pero como es una imagen completa no es necesaria esta instruccion.
        "#000"

    contains:
        ## Arbol_Planet.jpg es la imagen que aparece en el Menu Principal del juego.
        "Arbol_Planet.jpg"
        size (800, 600)
...
init python:
    ...
    build.directory_name = "Conciencia_Ecologica-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Conciencia_Ecologica"
